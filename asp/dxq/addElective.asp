...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
		<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
			  <tr>
					<div align="center"><h2>选课数据 EXCEL导入 模板下载</h2></div>
			  </tr>
			  <tr>
					<div align="center"><a href="downfiles/elective.xls"><h2>点击下载模板</h2></a></div>
			  </tr>
			  <tr>
					<div align="center">
				<span><h2 style="color:red;">选择文件-> 提交 -> 会出现文件列表 选择导入 ->导入成功后，应<a href="editElective.asp">查询</a>下导入的数据格式是否正确<h2></span>
				</div>
			  </tr>
  ...
  <tr>
    ...
    <tr>
		<td>
			<form name="frmSend" method="POST" enctype="multipart/form-data" accept-charset="GBK" action="addElective.asp" onSubmit="return onSubmitForm();">
				<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
				  <tr>
...
function SaveFiles
    ...
    if (UBound(ks) <> -1) then
        ...
        for each fileKey in Upload.UploadedFiles.keys
            ...
            SaveFiles = SaveFiles &"<a id='upload' onclick='upload()' href='electiveInsert.asp?"&Upload.UploadedFiles(fileKey).FileName &"'>导入</a>"
        next
